...
wifi_connect () {
    ...
    do
        ...
        systemctl start NetworkManager; nmcli device set ${WIFI_ADAPTER} managed yes  # Make sure we turn on managed mode again in case we didn't recover it in the trap below
